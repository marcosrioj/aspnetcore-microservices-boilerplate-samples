...
namespace MicroserviceBaseProject.Migrator
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            using (var bootstrapper = AbpBootstrapper.Create<MicroserviceBaseProjectMigratorModule>())
            {
                ...
                using (var migrateExecuter = bootstrapper.IocManager.ResolveAsDisposable<MicroserviceBaseProjectMigrateExecuter>())
                {
