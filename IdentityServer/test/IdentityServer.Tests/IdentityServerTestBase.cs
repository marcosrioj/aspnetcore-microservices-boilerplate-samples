...
using Shared.EntityFrameworkCore.Seed.Host;
using Shared.EntityFrameworkCore.Seed.Tenants;
using Shared.Authorization.Users;
using Shared.MultiTenancy;

namespace IdentityServer.Tests
{
    public abstract class IdentityServerTestBase : AbpIntegratedTestBase<IdentityServerTestModule>
    {
        protected IdentityServerTestBase()
        {
            void NormalizeDbContext(SharedDbContext context)
            {
