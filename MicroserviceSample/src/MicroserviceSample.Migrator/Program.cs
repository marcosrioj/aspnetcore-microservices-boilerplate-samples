...
namespace MicroserviceSample.Migrator
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            using (var bootstrapper = AbpBootstrapper.Create<MicroserviceSampleMigratorModule>())
            {
                ...
                using (var migrateExecuter = bootstrapper.IocManager.ResolveAsDisposable<MicroserviceSampleMigrateExecuter>())
                {
